...
//  Copyright © 2017年 爱菜铺. All rights reserved.
//
...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.clickTitleColor = [UIColor grayColor];
        self.clickborderColor = [UIColor grayColor];
        self.clickArray = nil;
        self.clickbool = YES;
        self.borderSize = 0.5;
...
-(void)setTagsFrame:(IMJIETagFrame *)tagsFrame{
    ...
    for (NSInteger i=0; i<tagsFrame.tagsArray.count; i++) {
        ...
        [self makeCorner:self.borderSize view:tagsBtn color:self.clickborderColor cornerRadius:self.cornerRadius];
...
- (void)setClickborderColor:(UIColor *)clickborderColor {
    if (_clickborderColor!= clickborderColor) {
        _clickborderColor = clickborderColor;
    }
}
    ...
    for (id obj in self.subviews) {
        if ([obj isKindOfClass:[UIButton class]]) {
            ...
            if (btn.tag == index){
                ...
                [self makeCorner:_borderSize view:btn color:UIColorRGBA(221, 221, 221, 1) cornerRadius:self.cornerRadius];
        ...
        if ([obj isKindOfClass:[UIButton class]]) {
            ...
            if (btn.tag == [index integerValue]){
                ...
                if ([selectedBtnList containsObject:index]) {
                    ...
                    btn.backgroundColor = self.clickBackgroundColor;
                    [btn setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
                    [self makeCorner:_borderSize view:btn color:[UIColor grayColor] cornerRadius:self.cornerRadius];
